...
## EXASCALAR PLOT
    ...
    p <- p + theme(
        ...
        panel.grid.major = element_line(colour = "palegoldenrod"),
        panel.grid.minor = element_line(colour = "palegoldenrod")
        )
...
```{r, echo=FALSE, fig.align='center', fig.height=7.25, fig.width=7.75, warning=FALSE}
